...
public class SOACTParser extends Parser {
	...
	public final JoinBlockBodyContext joinBlockBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 7)) & ~0x3f) == 0 && ((1L << (_la - 7)) & 8071822740170408067L) != 0)) {
				{
				setState(400);
	...
	public final ConstructorCallContext constructorCall() throws RecognitionException {
		...
		try {
			...
			if (((((_la - 7)) & ~0x3f) == 0 && ((1L << (_la - 7)) & 8071822740170408067L) != 0)) {
				{
				setState(516);
				((ConstructorCallContext)_localctx).exp = expression(0);
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case DECREMENT:
				...
				setState(622);
				((ExpressionContext)_localctx).e7 = expression(10);
			...
			case MINUS:
				...
				setState(626);
				((ExpressionContext)_localctx).e8 = expression(9);
			...
			case NOT:
				...
				setState(630);
				((ExpressionContext)_localctx).e9 = expression(8);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						match(DOT);
						setState(640);
						((ExpressionContext)_localctx).e5 = expression(13);
					...
					case 2:
						...
						setState(645);
						((ExpressionContext)_localctx).e11 = expression(8);
					...
					case 3:
						...
						setState(650);
						((ExpressionContext)_localctx).e13 = expression(7);
					...
					case 4:
						...
						setState(655);
						((ExpressionContext)_localctx).e15 = expression(6);
					...
					case 5:
						...
						setState(660);
						((ExpressionContext)_localctx).e17 = expression(5);
					...
					case 6:
						...
						setState(665);
						((ExpressionContext)_localctx).e19 = expression(4);
					...
					case 7:
						...
						setState(670);
						((ExpressionContext)_localctx).e21 = expression(3);
